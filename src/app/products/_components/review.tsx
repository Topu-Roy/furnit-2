    ...
    <div className="mt-6 divide-y divide-gray-200">
      <div className="gap-3 py-6 sm:flex sm:items-start">
        ...
        <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">{review}</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="reviews-radio-3" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                {" "}
                Yes: 1{" "}
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 h-4 w-4 border-gray-300 bg-gray-100 focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800"
              />
              <label htmlFor="reviews-radio-4" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                No: 0{" "}
              </label>
            </div>
          </div>
