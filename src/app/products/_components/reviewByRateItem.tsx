...
export default function ReviewByRateItem({ count, rate, totalReviews }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      <p className="w-2 shrink-0 text-start text-sm font-medium leading-none text-gray-900 dark:text-white">{rate}</p>
      <svg
      ...
      <p className="w-8 shrink-0 text-right text-sm font-medium leading-none sm:w-auto sm:text-left">
