...
const Rating = ({ rate, readonly, className, totalStars = 5, handleSetRate }: Props) => {
      ...
      {[...Array<number>(totalStars)].map((_, index) => {
        ...
        return (
          <label key={index} className="cursor-pointer">
            <input type="radio" name="rating" value={ratingValue} className="hidden" onClick={() => !readonly && setRating(ratingValue)} />
            <svg
