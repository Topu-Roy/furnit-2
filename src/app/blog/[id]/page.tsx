  ...
  return (
    <div className="mt-[4rem] bg-gray-200 pt-8 md:pt-10 lg:pt-14">
      <div className="prose mx-auto max-w-7xl px-4 py-2 sm:py-3 md:py-4 xl:px-6">
        <h2 className="my-4 pt-2 text-center sm:mt-8 sm:text-left md:hidden">{blog.headline}</h2>
        ...
        <h2 className="my-4 hidden pt-2 md:block">{blog.headline}</h2>
        ...
        {blog.article.blocks.map(textBlock => (
          <div key={`${textBlock.heading.slice(0, 3)}-${textBlock.text.slice(0, 3)}-textBlock`}>
            <h2 key={textBlock.heading} className="group cursor-pointer hover:underline">
        ...
        <h2 className="mt-4 pb-8 text-center">You might also like</h2>
